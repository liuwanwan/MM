...
public class SuperDialog extends Dialog {
    ...
    private void initView() {
        ...
        viewRoot.setBackground(getDialogBackground(new float[]{dp2px(6), dp2px(6), dp2px(6), dp2px(6), dp2px(6), dp2px(6), dp2px(6), dp2px(6)}));
    ...
    private void initButtonLayout(ViewGroup viewRoot) {
        ...
        for (int i = 0; i < buttonTexts.length; i++) {
            ...
            if (buttonTexts.length == 1) {
                textView.setBackground(getButtonBackground(true, true, true));
            } else {
                if (i == 0) {
                    textView.setBackground(getButtonBackground(true, false, true));
                } else if (i == buttonTexts.length - 1) {
                    textView.setBackground(getButtonBackground(false, true, true));
                } else {
                    textView.setBackground(getButtonBackground(false, false, true));
                }
            }
    ...
    class ListDialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            menuItemView.setBackground(getButtonBackground(false, false, false));
            if (item.icon != 0) {
